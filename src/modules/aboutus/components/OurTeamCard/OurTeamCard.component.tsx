...
const OurTeamCardComponent: React.FC<OurTeamCardProps> = ({
  ...
  return <div className={`${ourTeamCardComponent} ${className} col-xl-3 col-md-6`} data-aos="fade-up" data-aos-offset="250" data-aos-duration="500">
    {/* <!-- Team card --> */}
    <div className="rlr-team-card rlr-team-card--v2">
      ...
      <div className="rlr-team-card__summary">
        ...
        <h3 className="rlr-team-card__subtitle">
          {name}
        </h3>
        {/* <!-- Team details --> */}
        <p className="rlr-team-card__desc">
          {describtion}
        </p>
      </div>
    </div>
