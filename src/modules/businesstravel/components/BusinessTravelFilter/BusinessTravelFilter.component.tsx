...
const businessTravelFilterComponent = "businessTravelFilterComponent";

const BusinessTravelFilterComponent: React.FC<
  BusinessTravelFilterProps
> = ({ className, service, serviceInfo }) => {
  ...
  return (
    <aside
      className={`${businessTravelFilterComponent} ${className} col-xl-3 rlr-search-results-page__sidebar`}
    >
...
export default BusinessTravelFilterComponent;
