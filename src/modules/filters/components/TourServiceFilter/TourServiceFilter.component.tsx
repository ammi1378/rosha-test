            ...
            <div className="rlr-product-filters__filters-wrapper">
                ...
                <div className="rlr-range-slider">
                    <span className="rlr-range-slider__price-box">
                        <input type="number" className="form-control" value="0" data-name-min="0" data-name-max="30" />
                        <input type="number" className="form-control" value="10" data-name-min="0" data-name-max="30" />
                    </span>
                    <input value="0" min="0" max="30" step="1" type="range" />
                    <input value="10" min="0" max="30" step="1" type="range" />
                </div>
                <div className="row mt-3">
                    <div className="col-xl-10">
                        <label className="rlr-form-label rlr-form-label--dark">Physical</label>
                        <select id="rlr-product-form-product-sub-category" className="form-select rlr-form-select">
