...
import {
  ...
  IServiceFilters,
  IPrivateJetFilters,
  PrivateJetServiceFilterProps,
} from "./PrivateJetServiceFilter.props";
const ratings = [5, 4, 3, 2, 1];
const privateJetServiceFilterComponent = "privateJetServiceFilterComponent";

const PrivateJetServiceFilterComponent: React.FC<PrivateJetServiceFilterProps> = ({
  className,
  service,
  serviceInfo,
}) => {
  const router = useRouter();
  const [filtersValue, setFiltersValue] = useState<IPrivateJetFilters>({
    keyword: "",
    rating: "",
    max: 0,
    min: 0,
  ...
  useEffect(() => {
    ...
    const filters: IPrivateJetFilters = {
      keyword: "",
      rating: "",
      min: 0,
      max: 0,
  ...
  return (
    <aside
      className={`${privateJetServiceFilterComponent} ${className} col-xl-3 rlr-search-results-page__sidebar`}
    >
...
export default PrivateJetServiceFilterComponent;
