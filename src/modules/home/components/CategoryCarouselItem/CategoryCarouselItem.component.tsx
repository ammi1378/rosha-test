...
const CategoryCarouselItemComponent: React.FC<CategoryCarouselItemProps> = ({
  ...
  return <div className={`${categoryCarouselItemComponent} ${className} swiper-slide`} data-aos={`fade-up`} data-aos-duration={`700`} data-aos-once={`true`}>
      {/* <!-- Category card item --> */}
      <article className="rlr-category-card">
        ...
        <header>
          <a href="./product-detail-page.html" className="rlr-category-card__title">
            <h4>
              {title}
            </h4>
          </a>
          <a href="./product-detail-page.html" className="rlr-category-card__sub-title">
            <span>
              {activities}
            </span>
          </a>
