...
const souvenirsMainContentFilterComponent =
  "souvenirsMainContentFilterComponent";

const SouvenirsMainContentFilterComponent: React.FC<
  SouvenirsMainContentFilterProps
> = ({ className, service, serviceInfo }) => {
  ...
  return (
    <aside
      className={`${souvenirsMainContentFilterComponent} ${className} col-xl-3 rlr-search-results-page__sidebar`}
    >
...
export default SouvenirsMainContentFilterComponent;
