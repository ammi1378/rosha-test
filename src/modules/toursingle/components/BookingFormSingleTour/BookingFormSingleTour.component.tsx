...
const BookingFormSingleTourComponent: React.FC<BookingFormSingleTourProps> = ({ className }) => {
  return <aside className={`${bookingFormSingleTourComponent} ${className} col-xl-4 col-xxxl-3 d-xl-block offset-xxxl-1 mt-5 mt-lg-0`}>
    <form className="rlr-booking-card">
      <fieldset className="rlr-fieldrow">
        <legend className="rlr-booking-card__legend--hide">Booking form</legend>
        <article itemScope itemType="https://schema.org/Offer"
          ...
          <header className="rlr-booking-card__offer">
            <h2 className="rlr-booking-card__price" itemScope
              itemType="https://schema.org/AggregateOffer">
              <span className="rlr-booking-card__current-price rlr-booking-card--currency"
                itemProp="priceCurrency"></span>
              <span itemProp="lowPrice"
                className="rlr-booking-card__current-price rlr-booking-card--low-price">Rome, Italy</span>
          ...
          <span className="rlr-booking-card__info">*London to Ancient Rome Short Weekend Tour</span>
        </article>
      </fieldset>
      <fieldset className="rlr-booking-card__results rlr-booking-card__results--found">
        ...
        <div className="rlr-icon-text rlr-booking-card__message">
          ...
          <div className="rlr-icon-text__text-wrapper">
            ...
            <span className="rlr-icon-text__subtext">Once you confirm booking, you&#x27;ll receive
