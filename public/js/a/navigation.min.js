!(function (e, t) {
  "function" == typeof define && define.amd
    ...
    ? (module.exports = t("Navigation"))
    : (e.Navigation = t("Navigation"));
})(this, function (e) {
  "use strict";
  var t = {
      breakpoint: 992,
    ...
    a = function (e, t) {
      if (void 0 !== this.namespaces && this.namespaces[e])
        return (
          this.removeEventListener(e.split(".")[0], this.namespaces[e], t),
  ...
  (window.on = document.on = Element.prototype.on = i),
    (window.off = document.off = Element.prototype.off = a),
    (window.check = document.check = Element.prototype.check = o);
  var s = function (e, t) {
  ...
  return function (e, i) {
    ...
    (a = e).init = function (e) {
      (a.options = n(t, e)),
        ...
        (a.menuItems = a.querySelectorAll(
          ".navigation-item, .navigation-dropdown-item"
        )),
        (a.menuLinks = a.querySelectorAll(
      ...
      for (
        ...
        (i[r].className += " navigation-submenu"),
          (i[r].parentNode.className += " has-submenu");
      if (a.options.autoSubmenuIndicator)
        for (r = 0; r < a.menuItems.length; r++)
          if (a.menuItems[r].classList.contains("has-submenu")) {
            var l = document.createElement("span");
            l.classList.add("submenu-indicator"),
              a.menuItems[r].children[1].classList.contains(
                "navigation-dropdown-left"
              ) && l.classList.add("submenu-indicator-left"),
              a.menuItems[r].children[0].appendChild(l);
          }
      (o = !matchMedia("(hover: none)").matches),
        u(),
        window.on("resize", u),
        a.options.overlay &&
        ...
        a
          .getElementsByClassName("navigation-button-toggler")[0]
          .on("click", function (e) {
            e.stopPropagation(), e.preventDefault(), a.toggleOffcanvas();
          }),
        a
          .getElementsByClassName("navigation-body-close-button")[0]
          .on("click", a.toggleOffcanvas),
      ...
      if (c.length > 0) for (r = 0; r < c.length; r++) b(c[r]);
      a.options.scrollMomentum &&
        a.navigationBody.classList.add("scroll-momentum"),
        a.options.onInit.call();
    };
    var u = function () {
      h(),
        r() < a.options.breakpoint &&
          l > a.options.breakpoint &&
          (a.classList.remove(a.options.landscapeClass),
          a.hideSubmenus("BODY"),
          v(),
          a.options.submenuIndicatorTrigger ? d() : (f("click.link"), d())),
        r() > a.options.breakpoint &&
          ...
          a.hideSubmenus("BODY"),
          v(),
          "click" === a.options.submenuTrigger ||
          navigator.userAgent.match(/Mobi/i) ||
          (navigator.maxTouchPoints > 1 && o)
            ? f("click.link")
            : g(),
    ...
    (a.toggleOffcanvas = function () {
      a.classList.contains(a.options.landscapeClass) ||
        (a.navigationBody.classList.contains("is-visible") ||
        a.classList.contains(a.options.landscapeClass)
          ? ((a.navigationBody.className += " is-invisible"),
            a.navigationBody.check("transitionend") ||
              a.navigationBody.on("transitionend", function () {
                a.navigationBody.classList.remove("is-visible"),
                  a.navigationBody.classList.remove("is-invisible"),
            ...
            a.overlayPanel.check("transitionend") ||
              a.overlayPanel.on("transitionend", function () {
                a.overlayPanel.classList.remove("is-visible"),
                  a.overlayPanel.classList.remove("is-invisible"),
                  a.overlayPanel.off("transitionend");
              }),
            a.options.onHideOffCanvas.call())
          : ((a.navigationBody.className += " is-visible"),
            a.overlayPanel.classList.add("is-visible"),
            a.options.onShowOffCanvas.call()));
    }),
      (a.showSubmenu = function (e) {
        e.nextElementSibling.classList.contains("is-visible") ||
          (e.nextElementSibling.className += " is-visible"),
          p(e);
      }),
        ...
        for (
          var t,
            n =
              (t =
                "BODY" === e
                  ? a.querySelectorAll(".navigation-submenu.is-visible")
          ...
          a.classList.contains(a.options.landscapeClass)
            ...
            t[n].previousElementSibling.getElementsByClassName(
              "submenu-indicator"
            ).length > 0 &&
    ...
    var f = function (e) {
          ...
          a.menuLinks[t].on(e, function (e) {
            if (e.target.parentNode.classList.contains("has-submenu")) {
              if (
                (e.preventDefault(),
                e.stopPropagation(),
                !e.target.parentNode.classList.contains("is-active"))
              )
                return (
                  e.target.parentNode.classList.contains("navigation-item") &&
                    a.hideSubmenus("BODY"),
                  (e.target.parentNode.className += " is-active"),
                  e.target.getElementsByClassName("submenu-indicator").length >
                    0 && (e.target.lastElementChild.className += " is-active"),
                  a.hideSubmenus(e.target.parentNode),
              ...
              if (
                ...
                e.target.getElementsByClassName("submenu-indicator").length >
                  0 && e.target.lastElementChild.classList.remove("is-active"),
                a.hideSubmenus(e.target),
                "_blank" === e.target.getAttribute("target") ||
                  "blank" === e.target.getAttribute("target"))
              )
          ...
          a.menuItems[e].classList.contains("has-submenu") &&
            (a.menuItems[e].on("mouseenter.item", function (e) {
              e.preventDefault(),
                ...
                e.target.classList.contains("has-submenu") &&
                  (a.showSubmenu(e.target.firstElementChild),
                  (e.target.className += " is-active"));
            }),
            a.menuItems[e].on("mouseleave.item", function (e) {
              if (
                ...
                var t =
                  ((n = e.target.lastElementChild),
                  { x: (i = n.getBoundingClientRect()).left, y: i.top });
                (e.clientX < t.x ||
                  e.clientX > t.x + e.target.lastElementChild.offsetWidth ||
                  e.clientY < t.y ||
                  e.clientY > t.y + e.target.lastElementChild.offsetHeight) &&
                  (a.hideSubmenus(e.target.firstElementChild),
                  e.target.classList.remove("is-active"));
              }
              var n, i;
            }));
      ...
      v = function () {
        ...
        for (var e = 0; e < a.menuItems.length; e++)
          a.menuItems[e].off("mouseenter.item"),
            a.menuItems[e].off("mouseleave.item");
        for (e = 0; e < a.menuLinks.length; e++)
          a.menuLinks[e].off("click.link");
      },
      p = function (e) {
        if (r() > a.options.breakpoint) {
          var t = a.navigationBody.offsetWidth;
          e.classList.contains("navigation-link") &&
            (e.offsetLeft + e.nextElementSibling.offsetWidth > t
              ? (e.nextElementSibling.style.right = 0)
              : (e.nextElementSibling.style.right = "auto"));
        }
      },
      h = function () {
        for (
          var e = a.navigationBody.querySelectorAll(
              ".navigation-item > .navigation-submenu"
            ),
            t = a.navigationBody.offsetWidth,
            n = 0;
          n < e.length;
          n++
        )
          e[n].previousElementSibling.offsetLeft + e[n].offsetWidth > t
            ? (e[n].style.right = 0)
            : (e[n].style.right = "auto");
      },
      b = function (e) {
        for (
          var t = e.getElementsByClassName("navigation-tabs-nav-item"),
            n = e.getElementsByClassName("navigation-tabs-pane"),
            i = 0;
          i < t.length;
          i++
        )
          t[i].on("click.tabs", function (e) {
            ...
            for (
              e.target.parentNode.classList.add("is-active"), i = 0;
              i < n.length;
              i++
            )
              n[i].classList.remove("is-active");
          ...
          o = function (e, t, n, i) {
            var o = {
              ...
              u =
                "number" == typeof e
                  ? e
                  : e.offsetTop + a.options.scrollSpyOffset,
              m = Math.round(l - u < c ? l - c : u);
            if ("requestAnimationFrame" in window == 0)
              return window.scroll(0, m), void (i && i());
            !(function e() {
              var a =
                  "now" in window.performance
                    ? performance.now()
                ...
                c = o[n](l);
              m < 0 && (m = 0),
                window.scroll(0, Math.ceil(c * (m - s) + s)),
                window.pageYOffset !== m ? requestAnimationFrame(e) : i && i();
            })();
          };
        !(function () {
            ...
            window.on("scroll.scrollSpy", function () {
              for (
                var t,
                  ...
                  l =
                    ((t = this.pageYOffset),
                    (o = Math.abs(a.options.scrollSpyOffset)),
                    parseInt(t, 10) + parseInt(o, 10)),
                  c = (this.pageXOffset, 0);
                c < r.length;
                c++
              ) {
                var u = r[c];
